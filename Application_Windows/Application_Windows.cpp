// Application_Windows.cpp : Defines the entry point for the application.
//
...
{
public:
    Win32Window(const WindowProps& Props, HWND* pHWND)
        : Window(Props), m_WindowHandle(pHWND) {}
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_APPLICATIONWINDOWS, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_APPLICATIONWINDOWS));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_APPLICATIONWINDOWS);
