...
{
public:
	UWPWindow(const WindowProps& Props, CoreWindow^ Window)
...
void App::Load(Platform::String^ entryPoint)
{
	//if (//m_main == nullptr)
	//{
	//	//m_main = std::unique_ptr<Application_UWP_CXMain>(new Application_UWP_CXMain());
	//}
}
...
void App::Run()
{
	UWPWindow m_Window(API::Window::WindowProps{ 800, 600 }, CoreWindow::GetForCurrentThread());
	API::D3D12Renderer m_Renderer(&m_Window);
